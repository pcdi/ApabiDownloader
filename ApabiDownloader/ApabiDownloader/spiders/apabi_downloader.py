...
def authentication_failed(response: scrapy.http.TextResponse) -> bool:
    ...
    If the response contains "您尚未登陆。", then the user is not yet logged in, that means that the authentication has
    failed.

    Args:
        response: A scrapy.http.TextResponse instance generated by the after_login() function.
